...
def main():
    ...
    # For reproducability
    object_from_dict(hparams['manual_seed'])
...
if __name__ == "__main__":
    main()
    'python -m retinaface.train -c /home/beefmilf/PycharmProjects/wheatDet/retinaface/configs/2020-07-20.yaml'
