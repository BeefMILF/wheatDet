...
def get_args():
    ...
    arg("-m", "--max_size", type=int, help="Resize the largest side to this number", default=1024)
                ...
                if hparams["visualize"]:
                    ...
                    for annotation in annotations:
                        ...
                        vis_image = cv2.rectangle(
                            image, (x_min, y_min), (x_max, y_max), color=(255, 255, 255), thickness=2
                        )
...
if __name__ == "__main__":
    '''
    python -m retinaface.inference -i /home/beefmilf/PycharmProjects/wheatDet/data/test -c /home/beefmilf/PycharmProjects/wheatDet/retinaface/configs/2020-07-20.yaml -o /home/beefmilf/PycharmProjects/wheatDet/test_output -w /home/beefmilf/PycharmProjects/wheatDet/2020-07-27/epoch=7.ckpt -v 
    '''
    main()
